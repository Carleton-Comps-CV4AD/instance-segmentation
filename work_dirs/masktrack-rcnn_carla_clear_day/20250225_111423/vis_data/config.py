...
dataset_to_be_tested = '/Data/video_data/'
...
launcher = 'none'
load_from = 'masktrack-rcnn_models/masktrack-rcnn_carla_clear_day/epoch_12.'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='val_foggyDeweather/annotations.json',
        data_prefix=dict(
            img='val_foggyDeweather/rgb', img_path='val_foggyDeweather/rgb'),
        data_root='/Data/video_data/',
